...
export default function CityBadge() {
  return (
    <div className="absolute top-4 left-4 z-10 flex flex-col gap-2">
      <div className="flex items-center gap-2 bg-[#111D32]/90 backdrop-blur-md rounded-full px-4 py-2 border border-[#1E3050] shadow-lg">
        <MapPin className="w-4 h-4 text-[#94A3B8]" />
        <span className="text-white text-[14px] font-medium">Waterloo, ON</span>
