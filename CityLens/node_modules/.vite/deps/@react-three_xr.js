import {
  ...
  forwardHtmlEvents,
  forwardObjectEvents
} from "./chunk-IVSDX45G.js";
import {
  MeshLineGeometry,
  MeshLineMaterial,
  tunnel
} from "./chunk-JHSJRSBR.js";
import {
  require_client
} from "./chunk-KC5UYM3W.js";
...
async function injectEmulator(store, emulateOptions, alert) {
  ...
  const { emulate } = await import("./emulate-2UDFKWJD.js");
  if (alert) {
